    ...
    translation: {
      ...
      tutoring: {
        ...
        courseData: [
          ...
          { id: 4, date: "20/03", type: "Laboratório", title: "Aula 04: Estrutura Sequencial e Condicional", description: "Comandos de decisão simples e composta (if/else).", lessons: [{ title: "Lógica booleana em C", type: "video" }, { title: "Estruturas if e else", type: "code" }, { title: "Lista 3", type: "doc", document: "lista 3.pdf" }] },
    ...
    translation: {
      ...
      tutoring: {
        ...
        courseData: [
          ...
          { id: 2, date: "06/03", type: "laboratory", title: "Class 02: Basic Concepts", description: "Constants, variables, primitive types, and input/output commands.", lessons: [{ title: "Data types in C (int, float, char)", type: "slide" }, { title: "List 1", type: "doc", document: "lista 1.pdf" }] },
          { id: 3, date: "13/03", type: "Theory", title: "Class 03: Assignments and Operators", description: "Arithmetic expressions, precedence, and relational operators.", lessons: [{ title: "Arithmetic and Relational Operators", type: "slide" }, { title: "List 2", type: "doc", document: "lista 2.pdf" }] },
          { id: 4, date: "20/03", type: "laboratory", title: "Class 04: Sequential and Conditional Structure", description: "Simple and compound decision commands (if/else).", lessons: [{ title: "Boolean logic in C", type: "video" }, { title: "Structures if and else", type: "code" }, { title: "List 3", type: "doc", document: "lista 3.pdf" }] },
    ...
    translation: {
      ...
      tutoring: {
        ...
        courseData: [
          ...
          { id: 4, date: "20/03", type: "Laboratório", title: "Clase 04: Estructura Secuencial y Condicional", description: "Comandos de decisión simple y compuesta (if/else).", lessons: [{ title: "Lógica booleana en C", type: "video" }, { title: "Estructuras if y else", type: "code" }, { title: "Lista 3", type: "doc", document: "lista 3.pdf" }] },
          ...
          { id: 6, date: "10/04", type: "Laboratório", title: "Clase 06: Repetición (Prueba al Inicio/Fin)", description: "Estructuras de repetición while y do-while.", lessons: [{ title: "Lazo While: Sintaxis y uso", type: "video" }, { title: "Lazo Do-While: Diferencias", type: "code" }, { title: "Lista 4", type: "doc", document: "lista 4.pdf" }] },
    ...
    translation: {
      ...
      tutoring: {
        ...
        courseData: [
          ...
          { id: 4, date: "20/03", type: "Laboratório", title: "Lezione 04: Struttura Sequenziale e Condizionale", description: "Comandi di decisione semplici e composti (if/else).", lessons: [{ title: "Logica booleana in C", type: "video" }, { title: "Strutture if e else", type: "code" }, { title: "Lista 3", type: "doc", document: "lista 3.pdf" }] },
